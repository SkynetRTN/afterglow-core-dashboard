<template>
  <div id="app">
    <div v-if="!initialized">
      <section class="section hero is-fullheight is-error-section" style="background: #0a121f">
        <div class="hero-body">
          <div class="container">
            <div class="column has-text-centered">
              ...
              <div class="column has-text-centered">
                <div class="content">
                  <b-progress v-if="!initializationError" size="is-small"></b-progress>
...
export default class extends Vue {
  ...
  onInitializedChanged(value: boolean, oldValue: boolean) {
    if (value) {
      ...
      this.$store.dispatch("ToggleMobileSideBar", AppModule.isAsideMobileExpanded);
    }
  }
}
</script>
