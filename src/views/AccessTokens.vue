  ...
  <div>
    ...
    <section class="section is-main-section">
      <div class="columns is-desktop">
        <div class="column">
          <card-component title="Tokens" icon="key" header-icon="reload" v-on:header-icon-click="refresh()">
            <token-table :tokens="tokens" :loading="loading" v-on:delete-token="onDeleteToken($event)"></token-table>
          </card-component>
        </div>

        <div class="column">
          <card-component title="Create New Token" icon="pencil">
            <create-token-form v-on:token-created="onTokenCreated($event)"></create-token-form>
          </card-component>
        </div>
      </div>
    </section>
